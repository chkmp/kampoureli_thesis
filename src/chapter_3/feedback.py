...
TR = 1000  # in ms
tbv = TbvNetworkInterface(HOST, PORT, timeout=TR/2) #SCAnner need to ask Michael what is dat
...
def get_instructions_end(session, run):
    if session == '1' and run == '1':
        instructions_text = 'Thank you for your attention.\n\n You have completed task 2 out of 3!'
    elif session == '1' and run == '2':
        instructions_text = 'Thank you for your attention.\n\n You have completed task 3 out of 3!'
    elif session == '2' and run == '1':
        instructions_text = 'Thank you for your attention.\n\n You have completed task 2 out of 4!'
    elif session == '2' and run == '2':
        instructions_text = 'Thank you for your attention.\n\n You have completed task 3 out of 4!'
    elif session == '2' and run == '3':
        instructions_text = 'Thank you for your attention.\n\n You have completed task 4 out of 4!'
    elif session == '3' and run == '1':
        instructions_text = 'Thank you for your attention.\n\n You have completed task 2 out of 4!'
    elif session == '3' and run == '2':
        instructions_text = 'Thank you for your attention.\n\n You have completed task 3 out of 4!'
    elif session == '3' and run == '3':
        instructions_text = 'Thank you for your attention.\n\n You have completed task 4 out of 4!'
