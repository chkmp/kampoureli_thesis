...
import numpy as np
from utils.esqs_imag import create_csv, thought_probe 
...
image_duration = 1
fixation_duration = 3 #between mini block fixation , iti 3 for 12 trials, made it to flexible function below
fixation_null_duration = 9 #for null blocks, , null here needs to be block duration + iti, made it to flexible function below
fixation_start_duration = 10 #10 volumes of fix
fixation_end_duration = 9 #10 volumes of fix, made it to flexible function so that training run 01 ends in even number
fixation_instr_duration = 1
null_blocks = [8, 17, 23, 34, 44, 51, 57]
...
def get_instructions_end(session, run):
    if session == '1' and run == '1':
        instructions_text = 'Thank you for your attention.\n\n You have completed task 1 out of 3!'
    if session == '1' and run == '2':
        instructions_text = 'Thank you for your attention.\n\n You have completed task 1 out of 3!'
    elif session == '2' and run == '1':
        instructions_text = 'Thank you for your attention.\n\n You have completed task 1 out of 4!'
    elif session == '3' and run == '1':
        instructions_text = 'Thank you for your attention.\n\n You have completed task 1 out of 4!'
    elif session == '4' and run == '1':
        instructions_text = 'Thank you for your attention.\n\n You have completed task 1 out of 3!'
    elif session == '4' and run == '2':
        instructions_text = 'Thank you for your attention.\n\n You have completed task 3 out of 3!'
